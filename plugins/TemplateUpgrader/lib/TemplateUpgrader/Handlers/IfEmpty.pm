...
Here's an example of how you might use the E<lt>MTIfNotEmptyE<gt> tag:

    <MTIfNotEmpty tag="BlogDescription">
        <br /><strong><em><$MTBlogDescription$></strong></em>
    </MTIfNotEmpty>
